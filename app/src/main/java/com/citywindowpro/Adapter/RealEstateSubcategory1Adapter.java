...
public class RealEstateSubcategory1Adapter extends RecyclerView.Adapter<RealEstateSubcategory1Adapter.MyViewHolder> {
    private Typeface tf;
    Context context;
    List<FiveMainsubcatgory> listuser = new ArrayList<>();

    public RealEstateSubcategory1Adapter(Context context, List<FiveMainsubcatgory> listuser) {
