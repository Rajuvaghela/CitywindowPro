...
public class FiveMainProductActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_five_main_product);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        rv_main_product = (RecyclerView) findViewById(R.id.rv_main_product);
    ...
    public void subcategoryload() {
        if (isNetworkAvailable()) {
            ...
            client.post(Constants.liveuri + "sel_sub_category.php", params, new TextHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, String responseString) {
                    if (responseString != null) {
                        ...
                        rv_main_product.setLayoutManager(gridLayoutManager); // set LayoutManager to RecyclerView
                        //  call the constructor of FashionistaMainAdapter to send the reference and data to Adapter
                        FiveMainProductAdapter customAdapter = new FiveMainProductAdapter(FiveMainProductActivity.this, listuser);
                        rv_main_product.setAdapter(customAdapter);
                        rv_main_product.addOnItemTouchListener(new RecyclerItemClickListener(FiveMainProductActivity.this, new RecyclerItemClickListener.OnItemClickListener() {
                            @Override
            ...
            Toast.makeText(FiveMainProductActivity.this, "No Internet connection", Toast.LENGTH_SHORT).show();
        }
    }
