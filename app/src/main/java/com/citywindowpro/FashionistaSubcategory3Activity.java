...
public class FashionistaSubcategory3Activity extends AppCompatActivity {
    ...
    public void load_fashinista_subcategory2() {
        if (isNetworkAvailable()) {
            ...
            client.post(Constants.liveuri + "sel_fashion_list.php", params, new TextHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, String responseString) {
                    if (responseString != null) {
                        ...
                        mLayoutManager = new LinearLayoutManager(FashionistaSubcategory3Activity.this, LinearLayoutManager.VERTICAL, false);
                        rv_fashionista_sub3.setLayoutManager(mLayoutManager);
                        listAdapter = new FiveMainProductSubcategory1Adapter(FashionistaSubcategory3Activity.this, listuser);
                        rv_fashionista_sub3.setAdapter(listAdapter);
                        rv_fashionista_sub3.addOnItemTouchListener(new RecyclerItemClickListener(FashionistaSubcategory3Activity.this, new RecyclerItemClickListener.OnItemClickListener() {
                            @Override
            ...
            Toast.makeText(FashionistaSubcategory3Activity.this, "No Internet connection", Toast.LENGTH_SHORT).show();
        }
    }
